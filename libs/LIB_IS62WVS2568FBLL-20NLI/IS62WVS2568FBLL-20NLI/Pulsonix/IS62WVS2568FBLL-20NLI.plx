...
(library Library_1
	...
	(compDef "IS62WVS2568FBLL-20NLI" (originalName "IS62WVS2568FBLL-20NLI") (compHeader (numPins 8) (numParts 1) (refDesPrefix IC)
		...
		(compPin "3" (pinName "DNU(SIO2)") (partNum 1) (symPinNum 3) (gateEq 0) (pinEq 0) (pinType Unknown))
		...
		(compPin "7" (pinName "HOLD#(SIO3)") (partNum 1) (symPinNum 6) (gateEq 0) (pinEq 0) (pinType Unknown))
		...
		(attr "<Hyperlink>" "http://www.issi.com/WW/pdf/IS62-65WVS2568FALL-BLL.pdf")
		(attr "<Component Height>" "1.75")
		(attr "<STEP Filename>" "IS62WVS2568FBLL-20NLI.stp")
	)
